...
// Jsonify trait provides ToJson marshalling method
type Jsonify struct {
	self interface{}
}
...
// A Stringify trait provides improved ToString capability
...
// A Validator trait provides struct fields validation capability
